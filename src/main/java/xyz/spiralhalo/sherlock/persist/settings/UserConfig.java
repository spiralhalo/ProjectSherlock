...
import static xyz.spiralhalo.sherlock.persist.settings.UserConfig.UserNode.NOTIFICATIONS;
...
public class UserConfig {
	...
	public enum UserStr {
		...
		UserStr(UserNode node, String def) {
			this.node = node;
			this.def = def;
		}
	...
	public enum UserBool {
		...
		UserBool(UserNode node, boolean def) {
			this.node = node;
			this.def = def;
		}
