...
public class AppConfig {
	...
	public static HMSMode defaultHMSMode() {
		return HMSMode.STRICT;
	}
	...
	public static void setTabMainSelection(int i) {
		IniHandler.getInstance().putInt(NODE, KEY_TAB_MAIN_SELECTION, i);
	}

	public static void setTabReportsSelection(int i) {
		IniHandler.getInstance().putInt(NODE, KEY_TABR_SELECTION, i);
	}

	public static void setTabProjectsSelection(int i) {
		IniHandler.getInstance().putInt(NODE, KEY_TABS_SELECTION, i);
	}

	public static int getTabMainSelection() {
		return IniHandler.getInstance().getInt(NODE, KEY_TAB_MAIN_SELECTION, 0);
	}

	public static int getTabReportsSelection() {
		return IniHandler.getInstance().getInt(NODE, KEY_TABR_SELECTION, 0);
	}

	public static int getTabProjectsSelection() {
		return IniHandler.getInstance().getInt(NODE, KEY_TABS_SELECTION, 0);
	}

	public static void setLastCategory(String category) {
		IniHandler.getInstance().put(NODE, KEY_LAST_CATEGORY, category);
	}

	public static String getLastCategory() {
		return IniHandler.getInstance().get(NODE, KEY_LAST_CATEGORY, null);
	}

	public static void setFilterCategory(String category) {
		IniHandler.getInstance().put(NODE, KEY_FILTER_CATEGORY, category);
	}

	public static String getFilterCategory() {
		return IniHandler.getInstance().get(NODE, KEY_FILTER_CATEGORY, null);
	}

	public static void setFilterType(int type) {
		IniHandler.getInstance().putInt(NODE, KEY_FILTER_TYPE, type);
	}

	public static int getFilterType() {
		return IniHandler.getInstance().getInt(NODE, KEY_FILTER_TYPE, 0);
	}

	public static void setThumbSort(int sort) {
		IniHandler.getInstance().putInt(NODE, KEY_THUMB_SORT, sort);
	}

	public static int getThumbSort() {
		return IniHandler.getInstance().getInt(NODE, KEY_THUMB_SORT, 0);
	}

	public static boolean wizardLastVersionIsOutdated() {
		return IniHandler.getInstance().getInt(NODE, KEY_WIZARD_LAST_VERSION, 0) < Main.VERSION;
	}

	public static void setWizardLastVersion() {
		IniHandler.getInstance().putInt(NODE, KEY_WIZARD_LAST_VERSION, Main.VERSION);
	}
